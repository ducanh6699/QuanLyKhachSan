<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoSo.aspx.cs" Inherits="QuanLyKhachSanWeb.HoSo" EnableEventValidation="true" %>
                    ...
                    <div id="page-inner">
                        ...
                        <div class="col-md-4 col-md-offset-4" style ="box-shadow: 10px 10px grey; border: 1px solid black;padding-bottom: 10px;">
                            <div class="form-group">
                                <label for="TextBoxTen">Tên</label>
                                <asp:TextBox class="form-control" ID="TextBoxTen" runat="server" ></asp:TextBox>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="TextBoxDiaChi">Địa chỉ</label>
                                <asp:TextBox class="form-control" ID="TextBoxDiaChi" runat="server"></asp:TextBox>
                            </div>
                            <asp:Button ID="ButtonDoi" class="btn btn-success form-control" runat="server" Text="Đổi thông tin" OnClientClick="return confirm('Bạn chắc chắn chứ?')" OnClick="ButtonDoi_Click" />
