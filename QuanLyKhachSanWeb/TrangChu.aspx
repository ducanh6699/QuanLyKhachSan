            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="index.aspx"><i class="fa fa-dashboard"></i>Trang chủ
                            </a>
                        </li>
                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Thông tin khách hàng<asp:Button ID="ButtonXuat" class="btn btn-info" runat="server" Text="Xuất báo cáo" OnClick="ButtonXuat_Click" />
                                    </div>
